...
public class FacturaPdfView extends AbstractPdfView {
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter writer,
		...
		// #1 : ejemplo que requiere de messageSource y localeResolver
		Locale locale = localeResolver.resolveLocale(request);

		// #2 : ejemplo que no requiere de messageSource y localeResolver porque
		// getMessageSourceAccessor() se hereda de la super clase de Vista
		...
		cell = new PdfPCell(new Phrase(messageSource.getMessage("text.factura.ver.datos.ciente", null, locale)));

...
public class JpaUserDetailsService implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		if(usuario == null) {
			logger.error("Error login: no existe el usaurio '" + username + "'");
		...
		if(authorities.isEmpty()) {
			logger.error("Error login: no existe el usaurio '" + username + "' no tiene roles asociados");
			throw new UsernameNotFoundException("Usuario no tiene roles asociados");
		}
